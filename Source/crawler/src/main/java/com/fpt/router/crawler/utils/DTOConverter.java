...
public class DTOConverter {
    public static void convertRoute(com.fpt.router.crawler.model.entity.Route entityRoute, Route algorRoute) {
        ...
        algorRoute.trips = convertTrips(entityRoute.getTrips());
        algorRoute.pathInfos = convertPathInfos(entityRoute.getPathInfos());
    }

    public static void convertStation(com.fpt.router.crawler.model.entity.Station entityStation, Station algorStation) {
    ...
    public static void convertPathInfo(com.fpt.router.crawler.model.entity.PathInfo entityPathInfo, PathInfo algorPathInfo) {
    ...
    public static void convertConnection(com.fpt.router.crawler.model.entity.Connection entityConnection, Connection algorConnection) {
    ...
    public static List<PathInfo> convertPathInfos(List<com.fpt.router.crawler.model.entity.PathInfo> PathInfos) {
        List<PathInfo> res = new ArrayList<PathInfo>();
        for (com.fpt.router.crawler.model.entity.PathInfo entityPathInfo : PathInfos) {
            PathInfo pathInfo = new PathInfo();
            convertPathInfo(entityPathInfo, pathInfo);
            res.add(pathInfo);
        }
        return res;
    }
