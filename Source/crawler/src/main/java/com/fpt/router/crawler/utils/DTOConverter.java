...
public class DTOConverter {
    public static void convertRoute(CityMap map, com.fpt.router.crawler.model.entity.Route entityRoute, Route algorRoute) {
    ...
    public static void convertStation(CityMap map, com.fpt.router.crawler.model.entity.Station entityStation, Station algorStation) {
    ...
    public static void convertPathInfo(CityMap map, com.fpt.router.crawler.model.entity.PathInfo entityPathInfo, PathInfo algorPathInfo) {
    ...
    public static void convertTrip(CityMap map, com.fpt.router.crawler.model.entity.Trip entityTrip, Trip algorTrip) {
    ...
    public static void convertConnection(CityMap map, com.fpt.router.crawler.model.entity.Connection entityConnection, Connection algorConnection) {
    ...
    public static List<Trip> convertTrips(CityMap map, List<com.fpt.router.crawler.model.entity.Trip> entityTrips) {
    ...
    public static List<PathInfo> convertPathInfos(CityMap map, List<com.fpt.router.crawler.model.entity.PathInfo> PathInfos) {
        List<PathInfo> res = new ArrayList<PathInfo>();
        for (com.fpt.router.crawler.model.entity.PathInfo entityPathInfo : PathInfos) {
    ...
    public static List<Station> convertStations(CityMap map, List<com.fpt.router.crawler.model.entity.Station> stations) {
    ...
    public static List<Route> convertRoutes(CityMap map, List<com.fpt.router.crawler.model.entity.Route> routes) {
